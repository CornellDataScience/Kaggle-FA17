...
class ObjectDetection(keras.engine.topology.Layer):
    ...
    def call(self, x, training=None, **kwargs):
        ...
        def detections(num_output):
            ...
            pred_boxes = tensorflow_backend.gather_nd(pred_boxes,
            ...
            nms_indices = tensorflow_backend.non_maximum_suppression(boxes=pred_boxes, scores=max_scores, maximum=num_objects, threshold=0.7)
