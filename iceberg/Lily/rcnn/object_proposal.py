...
class ObjectProposal(keras.engine.topology.Layer):
    ...
    def call(self, inputs, **kwargs):
        ...
        deltas = common.bbox_transform_inv(anchors, deltas)

        # 2. clip predicted boxes to image
        proposals = common.clip(deltas, image_shape)
        ...
        indices = tensorflow_backend.argsort(scores)
        ...
        indices = tensorflow_backend.non_maximum_suppression(boxes=proposals, scores=scores, maximum=self.maximum_proposals, threshold=0.7)
